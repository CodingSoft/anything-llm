...
export default {
  ...
  discord: () => {
    return "https://discord.gg/codingsoft";
  },
  docs: () => {
    return "https://docs.codingsoft.com";
  },
  chatModes: () => {
    return "https://docs.codingsoft.com/features/chat-modes";
  },
  mailToMintplex: () => {
    return "mailto:team@codingsoft.com";
  },
  hosting: () => {
    return "https://my.codingsoft.com/aio-checkout?product=codingsoft";
  },
  workspace: {
    chat: (slug, options = {}) => {
  ...
  communityHub: {
    ...
    noPrivateItems: () => {
      return "https://docs.codingsoft.com/community-hub/faq#no-private-items";
    },
  },

  // TODO: Migrate all docs.codingsoft.com links to the new docs.
  documentation: {
    mobileIntroduction: () => {
      return "https://docs.codingsoft.com/mobile/overview";
    },
    contextWindows: () => {
      return "https://docs.codingsoft.com/chatting-with-documents/introduction#you-exceed-the-context-window---what-now";
    },
  },
