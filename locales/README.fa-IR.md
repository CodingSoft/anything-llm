...
<p align="center" dir="rtl">
👈 AnythingLLM برای دسکتاپ (مک، ویندوز و لینوکس)! <a href="https://codingsoft.org/download" target="_blank">دانلود کنید</a>
</p>
...
- 🆕 [**عامل‌های هوش مصنوعی سفارشی**](https://docs.anythingllm.codingsoft.org/agent/custom/introduction)
...
- [AnythingLLM Built-in](https://github.com/CodingSoft/anything-llm/tree/master/server/storage/models#audiovideo-transcription) (پیش‌فرض)
- [OpenAI](https://openai.com/)
...
- `embed`: زیرماژول برای تولید و ایجاد [ویجت قابل جاسازی وب](https://github.com/CodingSoft/anythingllm-embed).
- `browser-extension`: زیرماژول برای [افزونه مرورگر کروم](https://github.com/CodingSoft/anythingllm-extension).
...
[مشاهده همه رویدادهای تله‌متری در کد منبع](https://github.com/search?q=repo%3ACodingSoft%2Fanything-llm%20.sendTelemetry(&type=code)
