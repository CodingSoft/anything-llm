...
<p align="center">
👉 适用于桌面（Mac、Windows和Linux）的AnythingLLM！<a href="https://codingsoft.org/download" target="_blank">立即下载</a>
</p>

这是一个全栈应用程序，可以将任何文档、资源（如网址链接、音频、视频）或内容片段转换为上下文，以便任何大语言模型（LLM）在聊天期间作为参考使用。此应用程序允许您选择使用哪个LLM或向量数据库，同时支持多用户管理并设置不同权限。

![聊天](https://github.com/CodingSoft/anything-llm/assets/16845892/cfc5f47c-bd91-4067-986c-f3f49621a859)
...
- 🆕 [**完全兼容 MCP**](https://docs.anythingllm.codingsoft.org/mcp-compatibility/overview)
- 🆕 [**无代码AI代理构建器**](https://docs.anythingllm.codingsoft.org/agent-flows/overview)
- 🖼️ **多用户实例支持和权限管理（支持封闭源和开源LLM！）**
- [**自定义人工智能代理**](https://docs.anythingllm.codingsoft.org/agent/custom/introduction)
- 👤 多用户实例支持和权限管理 _仅限Docker版本_
- 🦾 工作区内的智能体（浏览网页、运行代码等）
- 💬 [为您的网站定制的可嵌入聊天窗口](https://github.com/CodingSoft/anythingllm-embed/blob/main/README.md)
...
- [AnythingLLM内置](https://github.com/CodingSoft/anything-llm/tree/master/server/storage/models#audiovideo-transcription) （默认）
- [OpenAI](https://openai.com/)
...
- `embed`: 用于生成和创建[网页嵌入组件](https://github.com/CodingSoft/anythingllm-embed)的子模块.
- `browser-extension`: 用于[Chrome 浏览器扩展](https://github.com/CodingSoft/anythingllm-extension)的子模块.
...
[在源代码中查看所有信息收集活动](https://github.com/search?q=repo%3ACodingSoft%2Fanything-llm%20.sendTelemetry(&type=code)
...
本项目采用[MIT](https://github.com/CodingSoft/anything-llm/blob/master/LICENSE)许可证。
