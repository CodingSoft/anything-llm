...
<p align="center">
  👉 CodingSoft for desktop (Mac, Windows, & Linux)! <a href="https://codingsoft.com/download" target="_blank"> Download Now</a>
</p>

A full-stack application that enables you to turn any document, resource, or piece of content into context that any LLM can use as a reference during chatting. This application allows you to pick and choose which LLM or Vector Database you want to use as well as supporting multi-user management and permissions.

![Chatting](https://github.com/CodingSoft/anything-llm/assets/16845892/cfc5f47c-bd91-4067-986c-f3f49621a859)
...
- 🆕 [**Full MCP-compatibility**](https://docs.codingsoft.com/mcp-compatibility/overview)
- 🆕 [**No-code AI Agent builder**](https://docs.codingsoft.com/agent-flows/overview)
- 🖼️ **Multi-modal support (both closed and open-source LLMs!)**
- [**Custom AI Agents**](https://docs.codingsoft.com/agent/custom/introduction)
- 👤 Multi-user instance support and permissioning _Docker version only_
- 🦾 Agents inside your workspace (browse the web, etc)
- 💬 [Custom Embeddable Chat widget for your website](https://github.com/CodingSoft/anythingllm-embed/blob/main/README.md) _Docker version only_
...
- [AnythingLLM Built-in](https://github.com/CodingSoft/anything-llm/tree/master/server/storage/models#audiovideo-transcription) (default)
- [OpenAI](https://openai.com/)
...
- `embed`: Submodule for generation & creation of the [web embed widget](https://github.com/CodingSoft/anythingllm-embed).
- `browser-extension`: Submodule for the [chrome browser extension](https://github.com/CodingSoft/anythingllm-extension).

## 🛳 Self-Hosting

CodingSoft & the community maintain a number of deployment methods, scripts, and templates that you can use to run CodingSoft locally. Refer to the table below to read how to deploy on your preferred environment or to automatically deploy.
...
_These are apps that are not maintained by CodingSoft, but are compatible with CodingSoft. A listing here is not an endorsement._
...
CodingSoft by CodingSoft Inc contains a telemetry feature that collects anonymous usage information.

<details>
<summary><kbd>More about Telemetry & Privacy for CodingSoft</kbd></summary>
...
- [Contributing to CodingSoft](./CONTRIBUTING.md) - How to contribute to CodingSoft.
...
[![codingsoft contributors](https://contrib.rocks/image?repo=CodingSoft/anything-llm)](https://github.com/CodingSoft/anything-llm/graphs/contributors)

[![Star History Chart](https://api.star-history.com/svg?repos=CodingSoft/anything-llm&type=Timeline)](https://star-history.com/#CodingSoft/anything-llm&Date)
...
[profile-link]: https://github.com/CodingSoft
[vector-admin]: https://github.com/CodingSoft/vector-admin
[assistant-swarm]: https://github.com/CodingSoft/openai-assistant-swarm
...
[render-deploy]: https://render.com/deploy?repo=https://github.com/CodingSoft/anything-llm&branch=render
[render-btn]: https://render.com/images/deploy-to-render-button.svg
[render-deploy]: https://render.com/deploy?repo=https://github.com/CodingSoft/anything-llm&branch=render
...
[elestio-deploy]: https://elest.io/open-source/codingsoft
[northflank-btn]: https://assets.northflank.com/deploy_to_northflank_smm_36700fb050.svg
[northflank-deploy]: https://northflank.com/stacks/deploy-codingsoft
