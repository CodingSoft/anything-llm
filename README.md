...
<p align="center">
  <a href="https://github.com/CodingSoft/anything-llm"><img src="https://github.com/CodingSoft/anything-llm/blob/master/images/wordmark.png?raw=true" alt="CodingSoft AnythingLLM logo"></a>
</p>

<div align='center'>
<a href="https://github.com/CodingSoft/anything-llm" target="_blank"><img src="https://img.shields.io/github/stars/CodingSoft/anything-llm?style=social" alt="CodingSoft AnythingLLM"></a>
</div>
...
<p align="center">
  ...
  <a href="https://docs.codingsoft.org" target="_blank">
    Docs
  </a> |
   <a href="https://codingsoft.org" target="_blank">
    CodingSoft Website
  </a>
</p>
...
<p align="center">
👉 AnythingLLM for desktop (Mac, Windows, & Linux)! <a href="https://codingsoft.org/download" target="_blank"> Download Now</a>
</p>
...
- 🆕 [**Full MCP-compatibility**](https://docs.codingsoft.org/mcp-compatibility/overview)
- 🆕 [**No-code AI Agent builder**](https://docs.codingsoft.org/agent-flows/overview)
- 🖼️ **Multi-modal support (both closed and open-source LLMs!)**
- [**Custom AI Agents**](https://docs.codingsoft.org/agent/custom/introduction)
...
CodingSoft & the community maintain a number of deployment methods, scripts, and templates that you can use to run AnythingLLM locally. Refer to the table below to read how to deploy on your preferred environment or to automatically deploy.
...
_These are apps that are not maintained by CodingSoft, but are compatible with AnythingLLM. A listing here is not an endorsement._
...
AnythingLLM by CodingSoft Inc contains a telemetry feature that collects anonymous usage information.
...
[View all telemetry events in source code](https://github.com/search?q=repo%3ACodingSoft%2Fanything-llm%20.sendTelemetry(&type=code)
...
[![anythingllm contributors](https://contrib.rocks/image?repo=codingsoft/anything-llm)](https://github.com/codingsoft/anything-llm/graphs/contributors)
...
Copyright © 2026 [CodingSoft][profile-link]. <br />
